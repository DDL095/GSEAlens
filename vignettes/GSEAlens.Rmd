...
- **Parallelization**: GSEAlens uses `r Biocpkg("BiocParallel")` for
  multi-contrast parallel computation, automatically adapting to the host
  platform (Windows: `SnowParam`; Linux/macOS: `MulticoreParam`).
