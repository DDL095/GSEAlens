...
`dds_se`, `dds`) are prepared following the preprocessing vignette, then passed
to GSEAlens functions below.

```{r load-prepared-objects, eval=FALSE}
# Run the preprocessing vignette to obtain fit / dds_se / dds:
# vignette("GSEAlens-preprocessing")
```
