...
Edge thickness is proportional to overlap ratio; node size reflects `|NES|`.
...
- **Node sizing**: by degree, betweenness, or page-rank
- **Network statistics**: summary panel showing node count, edge count, density

Source: `R/16_shiny_mod_hubgene_vis.R`.
