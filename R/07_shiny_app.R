...
launch_gsea_app <- function(gsea_res, addition_data = NULL) {
  ...
  if (!inherits(gsea_res, "GseaRes")) {
    stop("Please provide a valid GseaRes object (generated by batch_calc_gsea())")
  }
...
#'   Supports data.frame objects or file paths (.csv, .rds formats).
#' @param addition_data A data.frame or character vector (file path)
#' @return A validated data.frame with addition data
#' @keywords internal
...
#'   Checks that input is a data.frame with required 'ID' column and
#'   removes duplicate entries if present.
#' @param data A data.frame to validate
#' @return Validated data.frame with character ID column
#' @keywords internal
...
# Auto-detect Addition Data -------------------------------------------------------------------


#' @title Auto-detect Addition Data
#' @description Search working directory for default addition_data files.
#'   Checks for 'addition_data_gsealens.rds' or 'addition_data_gsealens.csv'
#'   in the current working directory.
#' @return A validated data.frame or NULL if no file found
#' @keywords internal
...
# Launch GSEAlens Shiny App (Internal) --------------------------------------------------------


#' @title Launch GSEAlens Shiny App (Internal)
#' @description Core Shiny application launcher. Builds the UI layout and
#'   initializes all server modules for interactive GSEA analysis.
#' @param gsea_res A valid GseaRes object
#' @param addition_data Optional data.frame with pathway annotations
