...
GSEAlens_volcano_plot <- ggplot(GSEAlens_de_df, aes(x = logFC, y = -log10(pvalue))) +
  ...
  # Add ggrepel labels only for user genes (including both)
  ...
  scale_color_manual(
    ...
    labels = c("Both", "User", "Pathway", "Up", "Down", "NS")
  ) +
  labs(
    title = paste0(GSEAlens_left_group, " vs ", GSEAlens_right_group, " - DE Volcano"),
    subtitle = paste0("Both: ", GSEAlens_n_both, " | User: ", GSEAlens_n_user, " | Pathway: ", GSEAlens_n_pathway, " | Up: ", GSEAlens_n_up, " | Down: ", GSEAlens_n_down, " | NS: ", GSEAlens_n_ns),
    x = "log2 Fold Change",
    y = "-log10(P-value)"
  ) +
  theme_bw() +
...
# =============================================================================
# GSEAlens Joint Canvas Code Generator
# =============================================================================
