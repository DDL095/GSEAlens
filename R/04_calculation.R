  ...
  res_list <- future.apply::future_lapply(
    ...
    FUN = function(chunk_task_names,
      ...
      for (task_name in chunk_task_names) {
        ...
        # Note: gene-case detection uses term2gene + names(genelist) only.
        # (geneset_species was previously derived from gsea_env$geneset$species
        #  inside the future worker but never read; removed 2026-07-01.)
