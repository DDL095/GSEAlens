    ...
    output$multi_plot <- shiny::renderPlot({
      ...
      tryCatch(

        {
          ...
          # Use full gsea_res (extracted as "ALL") for cross-collection support

          # Fall back to sliced data_prep gsea_res for backward compatibility
          ...
          if (!is.null(gsea_res)) {
            ...
            plot_obj <- plot_directional_gsea(
            ...
            # Title auto-generated by plot_directional_gsea:

            #   single pathway -> nice label, multiple -> "Combined Display: N Pathway(s)"
